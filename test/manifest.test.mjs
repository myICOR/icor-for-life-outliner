...
test('commands: bare ids, sentence case, icons, no default hotkeys', () => {
  ...
  assert.deepEqual(ids, ['fold', 'unfold', 'move-up', 'move-down', 'indent', 'outdent', 'insert-above', 'delete-with-subtree', 'duplicate', 'expand-all', 'collapse-all', 'toggle-done', 'move-to']);
